...
export const metadata: Metadata = {
  title: "UI UX Design Course (90 Days) | PEP Software Academy",
  description:
    "Learn advanced UX design processes, UI design principles. Hands-on training in Figma, Adobe XD to create app UI screens.",
};

export default function UIUX90DaysPage() {
  const course = COURSES_DATA.find((c) => c.slug === "ui-ux-design-90-days")!;
      ...
      <section className="pt-24 pb-20 bg-[#F7F8F8] text-center border-b border-[#C6C2C1]/40">
        <div className="max-w-4xl mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#E9E8E6] text-[#C86A28] border border-[#C6C2C1] text-xs font-bold mb-4">
            ...
            <span>{course.duration} Hands-on Intensive</span>
          </div>
